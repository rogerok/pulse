...
var program = effect_1.Effect.gen(function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [5 /*yield**/, __values((0, probe_ts_1.probe)(url))];
            case 1:
                result = _a.sent();
                return [5 /*yield**/, __values(effect_1.Effect.sync(function () {
                        console.log("status ".concat(result.status, " in ").concat(result.elapsedMs, " ms"));
                    }))];
            case 2:
                _a.sent();
                return [2 /*return*/];
...
effect_1.Effect.runPromise(program).catch(function (cause) {
    console.error(cause);
    process.exit(2);
});
